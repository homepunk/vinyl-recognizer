...
import com.homepunk.github.vinylrecognizer.common.BasePresenter;
import com.homepunk.github.vinylrecognizer.feature.menu.camera.helper.CameraHelper;
...
public class CameraFragmentPresenter extends BasePresenter<CameraView> implements CameraPresenter {
    ...
    protected void init() {
        if (view != null) {
            ...
            mRxPermissions = new RxPermissions(view.getFragmentActivity());
        }
    }
    ...
    private void createPhotoFileName() {
